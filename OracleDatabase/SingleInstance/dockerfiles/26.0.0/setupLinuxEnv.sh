...
curl --noproxy '*' -O https://ca-artifacts.oraclecorp.com/auto-build/x86_64-build-output-8-dev/oracle-database-preinstall-26ai-1.0-0.1.el8.x86_64.rpm && \
dnf -y install oracle-database-preinstall-26ai-1.0-0.1.el8.x86_64.rpm openssl hostname file expect && \
rm -rf oracle-database-preinstall-26ai-1.0-0.1.el8.x86_64.rpm && \
rm -rf /var/cache/yum && \
